      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
            ...
            return (
              <a
                ...
                className={`text-sm font-medium transition ${
                  active
                    ? 'text-[#f4a426] border-b-2 border-[#f4a426]'
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-gradient-to-br from-[#f4a426] to-[#c4820a] flex items-center justify-center text-white font-semibold text-sm"
          >
            U
          </button>
        </div>
